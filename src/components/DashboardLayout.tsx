...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
    return (
        <div className="min-h-screen bg-[#0a0a0f] page-bg flex flex-col">
            <Sidebar />
            <main className="lg:ml-[260px] transition-all duration-300 flex-1 flex flex-col">
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                        <div className="flex flex-col items-center text-center gap-4">
                            <p className="text-[#5a5a70] text-sm">
                                &copy; 2026 <span className="text-[#8888a0] font-medium">Wiflow</span>. All rights reserved.
                            </p>
                            <p className="text-[#5a5a70] text-sm">
                            ...
                            <div className="text-[#3a3a50] text-xs space-y-1">
                                <p>Wiflow is a product of Kalipr Labs.</p>
