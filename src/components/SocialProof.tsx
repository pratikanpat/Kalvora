    ...
    return (
        <section className="landing-section pt-10 sm:pt-14" id="reviews">
            <div className="text-center mb-10 sm:mb-12">
                <p className="text-[#3E2F2B] text-[10px] font-bold uppercase tracking-[0.25em] mb-4">
                    What Designers Say
                </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 max-w-5xl mx-auto">
                {testimonials.map((t, i) => (
                    <div key={i} className="testimonial-card animate-fade-in" style={{ animationDelay: `${i * 100}ms` }}>
                        ...
                        <p className="text-[#6F6A66] text-sm leading-relaxed mb-5">
                            &ldquo;{t.quote}&rdquo;
                        </p>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-[#1E1E1E] text-sm font-semibold">{t.name}</p>
                                <p className="text-[#78716C] text-xs">{t.role} · {t.location}</p>
                            </div>
                        </div>
                    </div>
                ))}
