        ...
        <div className="min-h-screen bg-[#F6F3EF] flex items-center justify-center px-4">
            <div className="w-full max-w-md animate-fade-in">
                ...
                <div className="text-center mb-12">
                    ...
                    <h2 className="text-lg font-semibold text-[#1E1E1E] mb-1">Set New Password</h2>
                    <p className="text-[#78716C] text-sm">Choose a strong password for your account</p>
                </div>
                ...
                <div className="bg-[#F6F3EF] border border-[#E8E3DD] rounded-xl p-8">
                    {success ? (
                        ...
                        <div className="text-center py-4 animate-fade-in">
                            ...
                            <h3 className="text-[#1E1E1E] font-semibold text-lg mb-2">Password Updated!</h3>
                        ...
                        <div className="text-center py-8">
                            <Loader2 size={24} className="animate-spin text-[#3E2F2B] mx-auto mb-3" />
                            <p className="text-[#78716C] text-sm">Verifying your reset link...</p>
                        </div>
                    ) : (
                        /* Password Form */
                            ...
                            {error && (
                                <div className="bg-[#FDF2F2] border border-[#F5D0D0] rounded-xl px-4 py-3 text-[#B85C5C] text-sm animate-fade-in">
                                    ...
                                    {error.includes('expired') && (
                                        <Link href="/forgot-password" className="block mt-2 text-[#3E2F2B] hover:text-[#2F2421] font-medium">
                                            Request a new link →
                                        </Link>
                                    )}
                                </div>
